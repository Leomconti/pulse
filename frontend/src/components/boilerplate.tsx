        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group p-8 border border-border/50 rounded-2xl bg-gradient-to-br from-background to-muted/20 transition-all duration-500">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Zero-config React Router integration with Next.js. Get your modern SPA running in under 60 seconds with
                our optimized template.
              </p>
            </div>
          </div>
          ...
          <div className="group p-8 border border-border/50 rounded-2xl bg-gradient-to-br from-background to-muted/20 transition-all duration-500">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Experience buttery-smooth navigation with client-side routing while maintaining all the powerful
                features of Next.js ecosystem.
              </p>
            </div>
          </div>
          ...
          <div className="group p-8 border border-border/50 rounded-2xl bg-gradient-to-br from-background to-muted/20 transition-all duration-500">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Clean, intuitive architecture with TypeScript support, modern tooling, and a codebase that scales
                effortlessly with your project.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">React Router inside Next.js with client-side routing</p>
      </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  All routes redirect to <code className="bg-muted px-1.5 py-0.5 rounded text-xs">/shell</code> via
                  next.config.ts
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <code className="bg-muted px-1.5 py-0.5 rounded text-xs">ssr: false</code>
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">Real implementations you can build</p>
      </div>
      ...
      <div className="space-y-6">
        <div className="border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">Supports URL params, nested layouts, protected routes</p>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">Route guards, auth context, role-based access</p>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">Client-side data fetching, caching, optimistic updates</p>
          </div>
        </div>
